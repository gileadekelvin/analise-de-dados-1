...
Algumas observações estão repetidas e serão retiradas para a análise a seguir. Uma observação é considerada duplicada se possui a mesma url, ou seja, a mesma página de episódio no IMDB, que possui páginas individuais para cada episódio.
...
A conclusão das duas abordagens diferem, o que mostra que a resposta para a pergunta não é **absoluta** mas pode ser considerada **satisfatória** e coerente diante dos dados e dos critérios utilizados.
