...
Na análise de hoje buscaremos identificar quais os grupos de filmes do ator **Christian Bale** nos quais filmes de um mesmo grupo tem características semelhantes entre si mas que diferem de outros grupos.
...
```
Na primeira visualização vemos a maioria dos filmes de Bale tem bons indíces no tomatômetro embora ainda existam alguns que não são tão bons assim. Na segunda visualização percebemos que a maioria dos filmes encontra-se entre 0 e 200 milhões de dólares no Box Office.
...
```
Estamos visualizando a variável Box Office em escala de log pois não estamos interessados no valor absolluto da bilheteria em si mas na grandeza do quanto ela cresce com relação a outros filmes. 
...
#### Grupo 4 - Fracassos
Nesse grupo estão presentes filmes com baixa taxa de aprovação no Rotten Tomatoes e que também não obtiveram alta bilheteria nos EUA. Como exemplo temos: xXx - State of the Union e The Spirit, filmes que tiveram orçamento maior que o arrecadado no BOX OFFICE.
